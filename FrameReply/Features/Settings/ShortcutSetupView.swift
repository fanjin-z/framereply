            ...
            ScrollView {
                VStack(alignment: .leading, spacing: 22) {
                    ...
                    guideSection(
                        ...
                        text:
                            "Connect an active provider and allow provider sharing in FrameReply. If a Shortcut reports that consent is required, open Settings → Privacy & Data."
                    )
                    guideSection(
                        title: "Data Handling",
                        symbol: "hand.raised",
                        text:
                            "Selected content is sent to the active provider. Source images are discarded after processing; extracted messages are stored in FrameReply’s protected local database."
                    )
                }
                .padding(24)
                .padding(.bottom, 24)
